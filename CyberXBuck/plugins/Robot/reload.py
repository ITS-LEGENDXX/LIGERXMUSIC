...
from CyberXBuck.utils.database import get_authuser_names, get_cmode
from CyberXBuck.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from CyberXBuck.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Cyber.stop_stream(message.chat.id)
    except:
        pass
