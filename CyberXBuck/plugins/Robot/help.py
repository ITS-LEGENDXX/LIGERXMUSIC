...
from CyberXBuck.misc import SUDOERS
from CyberXBuck.utils import help_pannel
from CyberXBuck.utils.database import get_lang, is_commanddelete_on
from CyberXBuck.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from CyberXBuck.utils.inline.help import (help_back_markup,
                                          private_help_panel)
    ...
    if cb == "hb9":
        if CallbackQuery.from_user.id not in SUDOERS:
            return await CallbackQuery.answer(
                "ʜᴀᴀɴ ᴀᴀᴊᴀ ʙsᴅᴋ ʟᴜɴᴅ ʟᴇʟᴇ ᴍᴇʀᴀ.\n\nᴊʜᴀᴀᴛ ʙᴀʀᴀᴀʙᴀʀ ᴅɪᴍᴀᴀɢ ʜᴀɪ ɴᴀʜɪ ᴀᴜʀ ᴏᴡɴᴇʀ ʙᴀɴᴇɴɢᴇ.ᴛᴇʀᴀ ᴋʜᴜᴅᴋᴀ ʙɴᴀᴠᴀɴᴀ ʜᴇ ᴛᴏ ᴄᴏɴᴇᴛᴄᴛ ᴋᴀʀʟᴇ ᴘʀᴏ ᴅᴇᴠᴇʟᴏᴘᴇʀ ꜱᴇ [@Lynx_X_Bot](https://t.me/Lynx_X_Bot)", show_alert=True
            )
        else:
