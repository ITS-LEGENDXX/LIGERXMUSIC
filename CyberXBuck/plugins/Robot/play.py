...
from CyberXBuck import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from CyberXBuck.core.call import Cyber
from CyberXBuck.utils import seconds_to_min, time_to_seconds
from CyberXBuck.utils.channelplay import get_channeplayCB
from CyberXBuck.utils.database import is_video_allowed
from CyberXBuck.utils.decorators.language import languageCB
from CyberXBuck.utils.decorators.play import PlayWrapper
from CyberXBuck.utils.formatters import formats
from CyberXBuck.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from CyberXBuck.utils.database import is_served_user
from CyberXBuck.utils.inline.playlist import botplaylist_markup
from CyberXBuck.utils.logger import play_logs
from CyberXBuck.utils.stream.stream import stream
...
@app.on_callback_query(
    filters.regex("CyberymousAdmin") & ~BANNED_USERS
)
async def Cyberymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(
    filters.regex("CyberPlaylists") & ~BANNED_USERS
)
@languageCB
